                    ...
                    <div className="stay-trouble-block">
                        ...
                        <div className="stay-inner-text-top">
                            <p>
                                ...
                                업무 책임이 어디에 있는지 헷갈리는 문제가 생겼습니다.
                            </p>
                            <p>
                                운영 서비스에서는 화면보다 흐름이 먼저고,
                                기능보다 주체가 먼저라고 생각 했기 때문에 이 부분을 팀원과 논의하며 다시 정리했습니다.
                            </p>
                            <p>
                                논의 과정에서 할인은 상가가 발행하고, 정산은
                                관리자가 종료하는 흐름이라는 점을 합의 했고 역할/주체/순서를 구분해 문제를 해결했습니다.
                            </p>
                        </div>
                        <div className="stay-inner-text-bottom">
                            <p>
                                처음엔 기능과 화면을 기준으로 잡았는데, DB에서
                                관리해야하는 단위가 UI에서 가정한 단위와 달라서 충돌이 생겼습니다.
                            </p>
                            <p>
